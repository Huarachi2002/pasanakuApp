...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> getNotification()async{
    try {
      ...
      if(response.data['data'].length > 0) notification = true;
                    ...
                    SizedBox(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          if(dataFiltrada[index]['estado'] == filtro[currentIndex]) {
                            return Padding(
                              ...
                              child: Material(
                                child: ListTile(
                                  ...
                                  leading: ClipOval(
                                    child: 
                                      dataFiltrada[index]['path_image'] == null 
                                      ?Container(
                                  ...
                                  onTap: (){
                                    Provider.of<PartidaProvider>(context, listen: false).changePartida(
                                      newTitle: dataFiltrada[index]['name'], 
                                      newId: dataFiltrada[index]['id'].toString(),
                                      newEstado: dataFiltrada[index]['estado'], 
                                      newCuota: int.parse(dataFiltrada[index]['cuota'].toString()), 
                                      newPlayerTotal: int.parse(dataFiltrada[index]['number_of_players'].toString()) , 
                                      newPeriodo: dataFiltrada[index]['period']['name']
                                    );
